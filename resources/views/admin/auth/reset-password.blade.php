...
<body>
    ...
    <div class="wrapper">
        ...
        <section class="height-100vh d-flex align-items-center page-section-ptb login"
            style="background-image: url({{asset('admin/images/login-bg.jpg')}});">
            <div class="container">
                @include('admin.layouts.errors')
                <div class="row justify-content-center no-gutters vertical-align">
                    <div class="col-lg-4 col-md-6 bg-white">
                        <div class="login-fancy pb-40 clearfix">
                            <h3 class="mb-30"> تغير كلمه المرور</h3>
                            <form action="{{ route('password.update') }}" method="post">
                                ...
                                <div class="section-field mb-20">
                                    <label class="mb-10" for="Password"> تاكيد كلمه المرور * </label>
                                    <input id="Password" class="password form-control" type="password"
                                        placeholder="كلمه المرور" name="password_confirmation">
                                </div>
